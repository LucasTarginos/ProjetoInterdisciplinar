  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.containerInicio}>
        <Text style={styles.title}>Para recuperar sua senha, preencha abaixo:</Text>
        <View style={styles.imageContainer}>
        <Image source={require('../../assets/senha.png')} style={styles.image} resizeMode="contain" />
      </View>
      </View>
      ...
      <View style={styles.Help}>
        ...
        {isVisible && (
          <Text style={styles.text}>
            Não recebeu a senha ou continua com dúvidas?{'\n'}Procure a CAA de seu campus
          </Text>
        )}
      </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  containerInicio: {
    marginTop: hp('10%'), // 10% da altura da tela para espaçamento
  ...
  input: {
    ...
    marginBottom: hp('1%'), // 1% da altura da tela para espaçamento
